...
def batchfy_by_seq(
    ...
    while True:
        ...
        ilen = max(int(info[ikey][iaxis]["array_shape"][0]),int(info[ikey][iaxis]["head_shape"][0]))
        olen = (
...
def batchfy_by_bin(
    ...
    idim = int(sorted_data[0][1][ikey][0]["array_shape"][1])
    ...
    while True:
        ...
        while next_size < batch_bins and (start + b) < length:
            ilen = max(int(sorted_data[start + b][1][ikey][0]["array_shape"][0]),int(sorted_data[start + b][1][ikey][0]["head_shape"][0])) * idim
...
def batchfy_by_frame(
    ...
    while end != length:
        ...
        while (start + b) < length:
            ilen = max(int(sorted_data[start + b][1][ikey][0]["array_shape"][0]),int(sorted_data[start + b][1][ikey][0]["head_shape"][0]))
...
def make_batchset(
    ...
    for d in category2data.values():
        ...
        sorted_data = sorted(
            d.items(),
            key=lambda data: max(int(data[1][batch_sort_key][batch_sort_axis]["array_shape"][0]), int(
                data[1][batch_sort_key][batch_sort_axis]["head_shape"][0])),
